...
export default function AdminSermonLanguagesPage() {
  ...
  async function load() {
    const res = await fetch("/api/sermons/admin/languages")
  ...
  async function create() {
    ...
    setSaving(true)
    await fetch("/api/sermons/admin/languages", {
      method: "POST",
  ...
  async function update(id: number) {
    ...
    setSaving(true)
    await fetch(`/api/sermons/admin/languages/${id}`, {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  async function remove(id: number) {
    ...
    await fetch(`/api/sermons/admin/languages/${id}`, { method: "DELETE" })
    load()
  }
