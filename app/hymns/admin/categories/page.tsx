...
export default function AdminCategoriesPage() {
  ...
  async function load() {
    const [catRes, langRes] = await Promise.all([
      ...
      fetch("/api/hymns/admin/languages"),
    ])
  ...
  async function create() {
    ...
    setSaving(true)
    await fetch("/api/hymns/admin/categories", {
      method: "POST",
  ...
  async function update(id: number) {
    ...
    setSaving(true)
    await fetch(`/api/hymns/admin/categories/${id}`, {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  async function remove(id: number) {
    ...
    await fetch(`/api/hymns/admin/categories/${id}`, { method: "DELETE" })
    load()
  }
