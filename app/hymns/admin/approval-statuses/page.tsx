...
export default function AdminApprovalStatusesPage() {
  ...
  async function load() {
    const res = await fetch("/api/hymns/admin/approval-statuses")
  ...
  async function create() {
    ...
    setSaving(true)
    await fetch("/api/hymns/admin/approval-statuses", {
      method: "POST",
  ...
  async function remove(id: number, name: string) {
    ...
    await fetch(`/api/hymns/admin/approval-statuses/${id}`, { method: "DELETE" })
    load()
  }
